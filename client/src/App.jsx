...
function App() {
  ...
  const protectedRoutes = [
    { path: "/dash/", element: <Dashboard darkMode={darkMode} />, allowedRoles: ["admin"] },
    { path: "/profile", element: <Profile darkMode={darkMode} />, allowedRoles: ["admin", "customer", "employee"] },
    ...
    <div className="">
      ...
      <div className={`m mt-[60px] ${darkMode ? 'bg-blue-50' : 'bg-black'}  min-h-screen `} >
        ...
        <Routes>
          ...
          <Route path="/activate/:token" element={<Activate user={userData} darkMode={darkMode} />} />
